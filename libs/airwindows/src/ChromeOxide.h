...
class ChromeOxide : public AudioEffectX
{
  public:
    ...
    virtual void getParameterDisplay(VstInt32 index, char *text, float ext,
                                     bool isExt); // text description of the current value
