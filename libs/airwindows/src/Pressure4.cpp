...
void Pressure4::getParameterDisplay(VstInt32 index, char *text, float extVal, bool isExternal) {
    switch (index) {
        ...
        case kParamC: float2string ((EXTV(C) * 200.0) - 100.0, text, kVstMaxParamStrLen); break;
