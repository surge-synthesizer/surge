...
DefaultDirName={commoncf64}\VST3\{#MyAppPublisher}\
...
Type: filesandordirs; Name: "{commonappdata}\{#MyAppName}\wavetable_script_presets"
; clean up the mess from Surge XT 1.0 nightlies prior to PR #5727
Type: filesandordirs; Name: "{commoncf64}\VST3\{#MyAppPublisher}\Contents"
Type: filesandordirs; Name: "{commoncf64}\VST3\{#MyAppPublisher}\desktop.ini"
Type: filesandordirs; Name: "{commoncf64}\VST3\{#MyAppPublisher}\plugin.ico"
; clean up Surge XT 1.0 release stuff
Type: filesandordirs; Name: "{commonpf64}\{#MyAppPublisher}\{#MyAppName}.exe"
...
Source: {#SURGE_SRC}\resources\data\wavetable_script_presets\*; DestDir: {commonappdata}\{#MyAppName}\wavetable_script_presets\; Components: Data; Flags: recursesubdirs
