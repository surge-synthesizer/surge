                           ...
                           public Steinberg::Vst::IMidiMapping
{
  public:
    ...
    tresult PLUGIN_API setBusArrangements(Steinberg::Vst::SpeakerArrangement *inputs, int32 numIns,
    ...
    void editorDestroyed(Steinberg::Vst::EditorView *editor) override {} // nothing to do here
    ...
    virtual tresult PLUGIN_API getMidiControllerAssignment(
        int32 busIndex, int16 channel, Steinberg::Vst::CtrlNumber midiControllerNumber,
