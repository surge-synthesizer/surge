...
public:
   ...
   virtual void editorDestroyed (EditorView* editor) {} // nothing to do here
   ...
   void processParameterChanges(int sampleOffset, IParameterChanges* parameterEvents, int& eventIndex);
   ...
   //! when true, surge exports all normal 128 CC parameters, aftertouch and pitch bend as parameters (but not automatable)
