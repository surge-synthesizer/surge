                                            ...
                                            bool shouldDrawButtonAsDown)
{
    ...
    {
        const auto focusColor = skin->getColor(Colors::Dialog::Button::BackgroundHover);

        g.setColour(focusColor.withAlpha(0.25f));
        g.fillRoundedRectangle(tickBounds, rectRadius);
