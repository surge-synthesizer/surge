...
class aulayer : public AUInstrumentBase
{
  public:
    ...
    virtual ComponentResult StopNote(MusicDeviceGroupID inGroupID, NoteInstanceID inNoteInstanceID,
                                     UInt32 inOffsetSampleFrame);

    virtual OSStatus HandleNoteOn(UInt8 inChannel, UInt8 inNoteNumber, UInt8 inVelocity,
                                  UInt32 inStartFram);
    virtual OSStatus HandleNoteOff(UInt8 inChannel, UInt8 inNoteNumber, UInt8 inVelocity,
                                   UInt32 inStartFrame);
    virtual OSStatus HandleControlChange(UInt8 inChannel, UInt8 inController, UInt8 inValue,
                                         UInt32 inStartFrame);
    ...
    virtual OSStatus HandleMidiEvent(UInt8 status, UInt8 channel, UInt8 data1, UInt8 data2,
                                     UInt32 inStartFrame);
    ...
    virtual ComponentResult GetParameter(AudioUnitParameterID inID, AudioUnitScope inScope,
...
extern CFAUPresetRef CFAUPresetCreate(CFAllocatorRef inAllocator, SInt32 inPresetNumber,
