...
class SurgeLv2Wrapper
{
  public:
    ...
    void setEditor(SurgeLv2Ui *editor) { _editor = editor; }
    ...
    SurgeSynthesizer *synthesizer() const noexcept { return _synthesizer.get(); }
  ...
  private:
    ...
    static LV2_State_Status saveState(LV2_Handle instance, LV2_State_Store_Function store,
