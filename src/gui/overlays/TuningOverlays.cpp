...
class TuningEditor::GeneratorSection : public juce::Component,
                                       public juce::Button::Listener,
                                       public juce::TextEditor::Listener
{
  public:
    GeneratorSection(TuningEditor *ed) : editor(ed)
    {
...
TuningEditor::ToneEditor::ToneEditor(bool editable)
{
    int xpos = 2;
...
void TuningEditor::ToneEditor::buttonClicked(juce::Button *b) { parent->toggleToneDisplay(); }

void TuningEditor::ToneEditor::displayText(bool dt)
{
    if (dt)
    {
...
void TuningEditor::ToneEditor::incNotes()
{
    playingNotes++;
    if (playingLED.get())
    {
...
void TuningEditor::ToneEditor::decNotes()
{
    playingNotes--;
    if (playingLED.get())
    {
...
TuningEditor::TuningEditor(Tunings::Scale &inScale)
{
    scale = inScale;
...
void TuningEditor::buildUIFromScale()
{
...
void TuningEditor::toggleToneDisplay()
{
...
void TuningEditor::scaleNoteOn(int scaleNote)
{
...
void TuningEditor::scaleNoteOff(int scaleNote)
{
    if (scaleNote < toneEditors.size())
