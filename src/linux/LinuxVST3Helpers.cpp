...
class UpdateHandlerInit
{
  public:
    ...
    Steinberg::UpdateHandler *get() { return Steinberg::UpdateHandler::instance(); }
};
...
void LinuxVST3FrameOpen(VSTGUI::CFrame *that, void *parent, const VSTGUI::PlatformType &pt)
{
    ...
    // std::cout << "Special Magical VST3 Open " <<
    // VSTGUI::X11::RunLoop::instance().getXcbConnection() << std::endl;
