...
TEST_CASE("AudioInputEffect", "[fx]")
{
    ...
    for (InParamsGroup &panningTestCase : panningTestCases)
    {
        ...
        memcpy(panningTestCase.sceneALeftInput, zeros, BLOCK_SIZE);
        memcpy(panningTestCase.sceneARightInput, zeros, BLOCK_SIZE);
        memcpy(panningTestCase.sceneBLeftInput, zeros, BLOCK_SIZE);
        memcpy(panningTestCase.sceneBRightInput, zeros, BLOCK_SIZE);
        inParamsGroups.push_back(panningTestCase);
        ...
        memcpy(panningTestCase.audioLeftInput, zeros, BLOCK_SIZE);
        memcpy(panningTestCase.audioRightInput, zeros, BLOCK_SIZE);
