...
public:	
	...
	virtual bool setParameter01 (long index, float value, bool external=false, bool force_integer=false) = 0;
	virtual float getParameter01 (long index) = 0;
	virtual int remapExternalApiToInternalId(unsigned int x){ return x; }
	...
	virtual int get_n_inputs(){ return n_inputs; }
	virtual int get_n_outputs(){ return n_outputs; }	
	virtual int get_block_size(){ return block_size; }
