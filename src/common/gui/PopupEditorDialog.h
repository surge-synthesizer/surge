...
{
  public:
    PopupEditorDialog::PopupEditorDialog() { irange = -1; }
    enum
    {
        IDD = IDD_EVALUE
    };
    ...
    inline void PopupEditorDialog::SetText(char *a) { strncpy(textdata, a, TextDataSize); }

    inline void PopupEditorDialog::SetValue(int a) { sprintf(textdata, "%i", a); }

    inline void PopupEditorDialog::SetFValue(float a) { sprintf(textdata, "%f", a); }
