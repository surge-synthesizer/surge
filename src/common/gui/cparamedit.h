...
{
public:
	CParamEdit(const CRect &size, IControlListener *listener = 0, long tag = 0, CBitmap *pBackground = 0);
	~CParamEdit();
	...
	CColor getLineColor () { return lineColor; }
	...
	void setBgcolor(CColor bgcol){ envColor = bgcol; }

	virtual void bounceValue();

	virtual void setValue(float val);

	void setIntValue(int ival){ i_value = ival; bounceValue(); setDirty(); }
	int getIntValue(){ return i_value; }

	void setIntDefaultValue(int idef){ i_default = idef; }
	...
	void setIntMin(int value){ i_min = value; }
	int getIntMin(){ return i_min; }
	void setIntMax(int value){ i_max = value; }
	int getIntMax(){ return i_max; }
	void setIntStepSize(int value){ i_stepsize = value; }
	int getIntStepSize(){ return i_stepsize; }
	void setFloatMin(float value){ f_min = value; }
	float getFloatMin(){ return f_min; }
	void setFloatMax(float value){ f_max = value; }
	float getFloatMax(){ return f_max; }	
