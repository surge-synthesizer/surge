...
void gui_modsrcbutton::set_ismeta(bool b)
{
   is_metacontroller = b;
   setDirty();
}
...
void gui_modsrcbutton::setBipolar(bool b)
{
   bipolar = b;
   setDirty();
}
...
void gui_modsrcbutton::setblink(bool nblink)
{
...
void gui_modsrcbutton::setlabel(const char* lbl)
{
...
CMouseEventResult gui_modsrcbutton::onMouseDown(CPoint& where, const CButtonState& buttons)
{
...
CMouseEventResult gui_modsrcbutton::onMouseUp(CPoint& where, const CButtonState& buttons)
{
...
double gui_modsrcbutton::getMouseDeltaScaling(CPoint& where, const CButtonState& buttons)
{
