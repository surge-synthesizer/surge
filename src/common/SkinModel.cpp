...
namespace Surge
{
   namespace Skin
   {
      ...
      namespace LFO { // DONE
         ...
         Connector msegEditButton = Connector( "lfo.msegeditbutton", 597, 478, 11, 11, Connector::SWITCH, Connector::MSEG_EDIT )
         ...
         Connector lfoMenuButton = Connector( "lfo.menubutton", 5, 478, 13, 11, Connector::SWITCH, Connector::LFO_MENU )
