...
oscillator::oscillator(sub3_storage* storage, sub3_osc* oscdata, pdata* localcopy) : master_osc(0)
{
   // assert(storage);
   assert(oscdata);
...
osc_sine::osc_sine(sub3_storage* storage, sub3_osc* oscdata, pdata* localcopy)
...
osc_audioinput::osc_audioinput(sub3_storage* storage, sub3_osc* oscdata, pdata* localcopy)
    : oscillator(storage, oscdata, localcopy)
{}
