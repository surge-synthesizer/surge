...
oscillator_BLIT::oscillator_BLIT(sub3_storage* storage, sub3_osc* oscdata, pdata* localcopy)
...
osc_super::osc_super(sub3_storage* storage, sub3_osc* oscdata, pdata* localcopy)
...
template <bool is_init> void osc_super::update_lagvals()
{
