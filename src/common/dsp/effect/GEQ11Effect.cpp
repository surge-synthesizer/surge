...
void GEQ11Effect::init_ctrltypes()
{
   ...
   for (int i = 0; i < geq11_gain; i++)
   {
      ...
      fxdata->p[i].set_name(bands[i].c_str());
...
{
   fxdata->p[geq11_30].val.f = 0.f;
   fxdata->p[geq11_60].val.f = 0.f;
   fxdata->p[geq11_120].val.f = 0.f;
   fxdata->p[geq11_250].val.f = 0.f;
   fxdata->p[geq11_500].val.f = 0.f;
   fxdata->p[geq11_1k].val.f = 0.f;
   fxdata->p[geq11_2k].val.f = 0.f;
   fxdata->p[geq11_4k].val.f = 0.f;
   fxdata->p[geq11_8k].val.f = 0.f;
   fxdata->p[geq11_12k].val.f = 0.f;
   fxdata->p[geq11_16k].val.f = 0.f;

   fxdata->p[geq11_gain].val.f = 0.f;
}
