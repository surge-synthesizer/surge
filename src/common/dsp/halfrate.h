...
const double SHR_NUM[SHR_NSEC][3] = {
  ...
  {
                   1,  0.05050820570817,                 1 
  },
  {
                   1,  0.02143785084635,                 1 
  },
  {
                   1,  0.00825860312702,                 1 
  },
  {
                   1, 0.002450310837442,                 1 
  },
  {
                   1,0.0002559403222724,                 1 
  }
};
const int SHR_DL[SHR_NSEC] = { 1,3,3,3,3,3,3,3,3,3,3 };
const double SHR_DEN[SHR_NSEC][3] = {
  {
                   1,                 0,                 0 
  },
  {
...
public:
	...
	__forceinline double process(double x)
	{
		...
		for(int sec=1; sec<SHR_NSEC; sec++)
		{
			...
			filter_regs[sec][0] = filter_in*SHR_NUM[sec][1] - SHR_DEN[sec][1]*y + filter_regs[sec][1];
