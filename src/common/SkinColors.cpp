...
namespace Colors
{
   ...
   namespace Effect
   {
      ...
      namespace Menu
      {
         const Surge::Skin::Color Text("fxmenu.text", 0,0,0);
      }
      namespace SelectorPanel
      {
         const Surge::Skin::Color LabelBorder( "effect.selectorpanel.labelborder", 0,0,0 );
      }
   }
   ...
   namespace InfoWindow
   {
      ...
      const Surge::Skin::Color Border("infowindow.border", 0,0,0);
      const Surge::Skin::Color Text("infowindow.text", 0,0,0);
   ...
   namespace NumberField
   {
      const Surge::Skin::Color DefaultText("numberfield.text", 15, 15, 15),
                              DefaultHoverText( "numberfield.text.hover", 90, 60, 30 );
   }

   namespace Scene {
      const Surge::Skin::Color PitchBendText( "pitchbend.text", 255, 255, 255 ),
       PitchBendTextHover( "pitchbend.text.hover", 255, 210, 180 ),
       SplitPolyText( "splitpoly.text", 15, 15, 15 ),
       SplitPolyTextHover( "splitpoly.text.hover", 90, 60, 0 ),
       KeytrackText( "keytrack.text", 15, 15, 15 ),
       KeytrackTextHover( "keytrack.text.hover", 90, 60, 0 );
   }
   ...
   {
      const Surge::Skin::Color Background("status.button.background", 227, 227, 227),
                                 SelectedBackground("status.button.highlight", 255, 154, 16),
                                 Border("status.button.border", 151, 151, 151),
                                 Text("status.button.text.unselected", 0,0,0),
                                 SelectedText("status.button.text.selected", 0,0,0);
   }

   namespace VuMeter
   {
      const Surge::Skin::Color Level("vumeter.level", 5, 201, 13),
                                 HighLevel("vumeter.highlevel", 255, 0, 0),
                                 Background("vumeter.background", 205, 206, 212),
