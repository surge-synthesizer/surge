...
//-------------------------------------------------------------------------------------------------------
class vstlayer : public AudioEffectX
{
public:
   enum
   {
	...
	vstlayer (audioMasterCallback audioMaster);
	~vstlayer();
	...
	virtual VstInt32 getNumMidiInputChannels () { return 3; }				///< Return number of MIDI input channels
